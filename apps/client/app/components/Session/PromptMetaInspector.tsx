...
import {
  ...
  CLIENT_UNLIMITED_HISTORY_VALUE,
  PromptMeta,
  RAW_METADATA_DISCLOSURE_LABEL,
  ttfvtState,
    ...
    >
      ...
      >
        <CardContent>
          ...
          {/* The raw per-field renderer this panel superseded. Behind a disclosure rather than
              deleted: the verdict answers the reader's question, and these tabs are what an
              operator falls back to when the verdict is 'unknown'. */}
          <details data-testid="answer-diagnosis-raw-details">
            <summary>
                  ...
                  <Box>
                    ...
                    <Box sx={{ mt: 2 }}>
                      ...
                      <Stack spacing={1}>
                        ...
                        {promptMeta.context?.systemPromptSources &&
                          promptMeta.context.systemPromptSources.length > 0 && (
                            <Box>
