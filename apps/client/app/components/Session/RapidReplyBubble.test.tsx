...
// 'completed' is the only status the wire ever carries: pages/api/ai/rapid-reply.ts
// hardcodes it on the single sendRapidReplyUpdate call. A fixture using 'streaming'
// would let the render guard be tightened to exclude the real value and still pass.
