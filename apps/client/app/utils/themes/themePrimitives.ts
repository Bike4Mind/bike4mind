  ...
  dark: {
    palette: {
      ...
      warning: {
        solidBg: orange[450],
        solidColor: '#000000',
        solidHoverBg: orange[350],
        softBg: orangeAlpha[450][15],
        softHoverBg: orangeAlpha[450][22],
        softActiveBg: orangeAlpha[450][28],
        softColor: orange[450],
        outlinedColor: orange[450],
        outlinedBorder: orange[450],
      },
      feedback: {
        background: gray[850],
...
export const typography = {
  fontFamily: {
    ...
    display: '"Libre Franklin", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif',
  },
};
