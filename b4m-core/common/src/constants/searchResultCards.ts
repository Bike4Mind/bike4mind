/**
 * The fence language the model writes to place image cards inline in a reply, shared because four
 ...
 *   - the reply-download menu (apps/client .../utils/replyDownloads.ts) skips it so the card JSON
 *     is never offered as a downloadable file.
 *
