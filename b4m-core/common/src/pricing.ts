 ...
 * holder is debited past their remaining balance and the shortfall is written off -
 * once, since incrementCredits is an unclamped $inc and the resulting negative
 * balance fails the next turn's own gate.
 */
