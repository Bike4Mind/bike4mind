...
export const DEFAULT_MANIFEST = {
  ...
  GEMINI_API_KEY: { kind: 'secret' },
  GITHUB_CLIENT_ID: { kind: 'secret' },
  GITHUB_CLIENT_SECRET: { kind: 'secret' },
  GITHUB_ZAP_REF: { kind: 'secret', optional: true },
  GOOGLE_CLIENT_ID: { kind: 'secret' },
  GOOGLE_CLIENT_SECRET: { kind: 'secret' },
  JWT_SECRET: { kind: 'secret' },
  MAIL_FROM: { kind: 'secret' },
  MAIL_HOST: { kind: 'secret' },
  MAIL_PASSWORD: { kind: 'secret' },
  MAIL_PORT: { kind: 'secret' },
  MAIL_USERNAME: { kind: 'secret' },
  MONGODB_URI: { kind: 'secret' },
  OAUTH_RSA_PRIVATE_KEY: { kind: 'secret', optional: true },
  OKTA_AUDIENCE: { kind: 'secret' },
  OKTA_CLIENT_ID: { kind: 'secret' },
  OKTA_CLIENT_SECRET: { kind: 'secret' },
  ...
  SLACK_ERROR_REPORTING_WEBHOOK_URL: { kind: 'secret' },
  SLACK_WEBHOOK_URL: { kind: 'secret' },
  STRIPE_PUBLISHABLE_KEY: { kind: 'secret' },
  STRIPE_SECRET_KEY: { kind: 'secret' },
  STRIPE_WEBHOOK_SECRET: { kind: 'secret' },
  SUPPORT_EMAIL: { kind: 'secret' },
