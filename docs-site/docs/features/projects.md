...
description: How to use Projects to organize notebooks, files, and collaborate with team members
sidebar_position: 3
tags: [projects, organization, collaboration]
---
...
3. Files are processed and added to the project

**Add Existing Files:**
1. Click **Add Files**
2. Browse your knowledge library
...
- [Organizations & Teams](./organizations-teams.md) - Team-level collaboration
