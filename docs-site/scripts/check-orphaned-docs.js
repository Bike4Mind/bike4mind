...
class OrphanedDocsChecker {
  constructor() {
    ...
    this.allMdFiles = new Set();
    this.referencedFiles = new Set();
    this.nonExistentRefs = new Set();
  }

  // Find all .md files recursively
  findAllMdFiles(dir, baseDir = '') {
  ...
  parseSidebarsFile() {
    try {
      ...
      let content = fs.readFileSync(this.sidebarPath, 'utf8');
