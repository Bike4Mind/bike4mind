...
export function formatChunkSampleDoc(args: {
  ...
  const lines: string[] = [
    ...
    '',
    'MARK A PASSAGE UNUSABLE RATHER THAN SKIPPING IT. A boilerplate header, a table of contents or a',
    'fragment mid-sentence cannot ground a question, and that is a fact about the corpus worth having.',
    'Set `question` to the empty string and the record is excluded by construction, with the skip',
